...
$('a.js-scroll[href*="#"]:not([href="#"])').on("click", function() {
  if (location.pathname.replace(/^\//, '') ==
    ...
    if (target.length) {
      $('html, body')
          .animate({scrollTop : (target.offset().top - navHeight + 5)}, 1000,
                   "easeInOutExpo");
      return false;
    }
  }
...
$('body').scrollspy({target : '#mainNav', offset : navHeight});
/*--/ End Scrolling nav /--*/
...
$(document).ready(function() {
  var $date = new Date(), $copyrightYear = $date.getFullYear(),
      $copyright = $(".copyright"), $intialCount = 0,
      $totalQuotesNumber = 35 - 1,
      // There are actually 35 quotes, but you start counting from 0, so there
      // are 34
      $currentQuote, $currentAuthor, $quotes, $authors,
      $heartCount = $(".heart-cont"), $heartPlus = $(".heart-plus"),
      $newQuote = $(".new-quote"), $quoteContent = $("#quote-content"),
